...
class GetAy(xascraper.modules.scraper_base.ScraperBase):
	...
	def checkCookie(self):
		...
		if settings["ay"]["username"] in pagetext:
			return True, "Have Ay Cookie."
		else:
			return False, "Do not have Ay login Cookies"
		...
		try:
			...
			if action_target:
				...
				logondict = {
							"login"        : "1",
							"remember"        : "1",
							"username"      : settings["ay"]["username"],
							"password"      : settings["ay"]["password"],
							}
